...
function TOOL.BuildCPanel( panel )
	...
	pnl.PublicTransportOnly = vgui.Create( "DCheckBoxLabel", pnl )
	pnl.PublicTransportOnly:Dock( TOP )
	pnl.PublicTransportOnly:DockMargin( 0, 0, 0, 5 )
	pnl.PublicTransportOnly:SetText( L"tool.trolleytrafficeditor.ui.publictransportonly" )
	pnl.PublicTransportOnly:SetConVar( "trolleytrafficeditor_publictransportonly" )
	pnl.PublicTransportOnly:SetDark( true )
end
	...
	elseif cmd == 2 then
		if IsValid( pnl ) then
			...
			if id then
				...
				t.PublicTransportOnly = pnl.PublicTransportOnly:GetChecked()
				net.Start( "TrolleybusTrafficTrackEditor" )
				net.WriteUInt( 1, 4 )
				net.WriteUInt( id, 32 )
				net.WriteTable( t )
