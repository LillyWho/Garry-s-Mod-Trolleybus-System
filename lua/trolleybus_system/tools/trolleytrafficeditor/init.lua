...
-- Modified by LilyWho under Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International
	...
	elseif cmd == 3 then
		...
		self:BuildRotation( pos1, pos2, ang, self:GetClientNumber( "rotation_segments" ), self:GetClientNumber( "rotation_curvature" ), R, function( i, count, pos, prevpos )
			...
			local t = {
				...
				NoService = self:GetClientBool( "noservice" ),
				PublicTransportOnly = self:GetClientBool( "publictransportonly" )
			}
